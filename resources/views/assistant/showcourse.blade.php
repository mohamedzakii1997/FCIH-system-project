...
@section('content')
    <div class="container">
     ...
     <!-- upload file form in model -->
                    <form action="{{url('/assistant/upload')}}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
        ...
        <table id="bootstrap-data-table" class="table table-striped table-bordered">
            ...
            @foreach($courses as $obj)
                <tr>
                    ...
                    <td>
                        <a href="{{url('/assistant/students/'.$obj->id)}}" class="btn btn-primary" ><i class="fa fa-eye" aria-hidden="true"></i> Show Students</a>
...
function getcourseid(id) {
  ...
  http.open("GET","{{url('/assistant/files')}}"+'/?id='+id,true);
  http.send();
