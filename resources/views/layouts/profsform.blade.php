                          ...
                          <div class="card-header d-flex align-items-center">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                    <input id="inputHorizontalSuccess" class="form-control form-control-success" type="text" name="englishName" @yield('e_namevalue') required maxlength="50">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input id="inputHorizontalSuccess" class="form-control form-control-success" type="text" name="email" @yield('emailvalue') required maxlength="30">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3 form-control-label">salary</label>
                                    <div class="col-sm-9">
                                        <input id="inputHorizontalSuccess" class="form-control form-control-success" type="text" name="salary" @yield('salaryvalue') required maxlength="8">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3 form-control-label">SSN</label>
                                     <div class="col-sm-9">
                                        <input id="inputHorizontalSuccess" class="form-control form-control-success" type="number" name="SSN" @yield('ssnvalue') required maxlength="20">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3 form-control-label">Department</label>
                                    <div class="col-sm-9">
                                         <select class="form-control" name="mainDepartmentId" required>
                                            @yield('mainvalue')
                                         </select>
                                    </div>
                                </div>
