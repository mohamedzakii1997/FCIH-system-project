...
@section('content')
	<div class="container" style="background-color: #fff">
		...
		<h1 style="font-size: 30px;margin-bottom: 20px;font-weight: bold">Information Technology</h1>
		<ul class="deplist">
			<li><a href="{{url('departments/informationTechnology/programmeSpecification')}}" >Programme Specifications</a></li>
			<li><a href="{{url('departments/informationTechnology/facultyMembers')}}" >Faculty Members</a></li>
			<li><a href="{{url('departments/informationTechnology/courses')}}">Courses</a></li>
		</ul>
		<h2 style="font-size: 20px;margin:50px 0; font-weight: bold">Head of the Department of Information Technology</h2>
		<p>
A. M. D. Rueda Abdul Hamid Professor, Department of Computer Science and the supervisor of the department
		</p>
