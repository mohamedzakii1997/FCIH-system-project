...
@section('title')
	Information Technology - Programme Specification
@endsection
@section('content')
	<div class="container" style="background-color: #fff">
		...
		<p>
			1- Programme Title: Information Technology<br>

2- Programme Type:    Single                          Double                                    Multiple<br>

3- Department(s): Information Technology<br>
...
6- Year: 2010
		...
		<ol>
			<li>Programme aims
				<ol>
					<li>Enable graduates to exhibit a high level of practical and theoretical skills over a broad range of Information Technology together with knowledge of currently available techniques and technologies.</li>
					<li> Explore the principles that support developments in a rapidly changing environment.</li>
					<li>Provide opportunities for students to understand the wide range of research challenges facing Information Technology, as well as the breadth and depth of research undertaken in this top-rated school, so they are prepared to get on research here or elsewhere.</li>
...
A7. Define the basics of Computer Technologys.
...
A11. Recognize Operating Technologys Designs.
...
A24. Abstract the principles of Information Technologys.

A25. Apply the principles of Internet Technologies.

A26. Apply the principles of Information Technologies.

A27. Clarify advanced topics in Information Technology.') !!}
						</p>
						</ul>
					</li>
					<li>
...
Objectives
		...
		<ol>
			<li>The preparation of a distinguished graduate in the fields of Information Technology and programming and software engineering is able to compete in local labor markets , regional and global .</li>
			<li>Continuous improvement in academic programs and educational Technologys and research in line with the requirements of preparing a distinguished graduate competitive .</li>
			<li>Achieve excellence through studies and scientific and applied research in the areas of specialization.</li>
			<li>Service sector, the government and public business sector and civil society by organizing consulting and technical assistance to them and training the human resources capable of meeting the needs of these sectors in the areas of Information Technology and technology networks and the Internet.</li>
		</ol>
	</div>
@endsection