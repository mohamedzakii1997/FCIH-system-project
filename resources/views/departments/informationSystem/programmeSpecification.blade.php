...
@section('title')
	Information System - Programme Specification
@endsection
@section('content')
	<div class="container" style="background-color: #fff">
		...
		<p>
			1- Programme Title: Information System<br>

2- Programme Type:    Single                          Double                                    Multiple<br>

3- Department(s): Information System<br>
...
6- Year: 2010
		...
		<ol>
			<li>Programme aims
				<ol>
					<li>Enable graduates to exhibit a high level of practical and theoretical skills over a broad range of Information System together with knowledge of currently available techniques and technologies.</li>
					<li> Explore the principles that support developments in a rapidly changing environment.</li>
					<li>Provide opportunities for students to understand the wide range of research challenges facing Information System, as well as the breadth and depth of research undertaken in this top-rated school, so they are prepared to get on research here or elsewhere.</li>
...
A27. Clarify advanced topics in Information System.') !!}
						</p>
						</ul>
					</li>
					<li>
...
Objectives
		...
		<ol>
			<li>The preparation of a distinguished graduate in the fields of Information System and programming and software engineering is able to compete in local labor markets , regional and global .</li>
			...
			<li>Service sector, the government and public business sector and civil society by organizing consulting and technical assistance to them and training the human resources capable of meeting the needs of these sectors in the areas of Information System and technology networks and the Internet.</li>
		</ol>
	</div>
@endsection