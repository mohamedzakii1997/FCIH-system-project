...
@section('content')
	<div class="container" style="background-color: #fff">
		...
		<h1 style="font-size: 30px;margin-bottom: 20px;font-weight: bold">Computer Science</h1>
		<ul class="deplist">
			<li><a href="{{url('departments/computerScience/programmeSpecification')}}" >Programme Specifications</a></li>
			<li><a href="{{url('departments/computerScience/facultyMembers')}}" >Faculty Members</a></li>
			<li><a href="{{url('departments/computerScience/courses')}}">Courses</a></li>
		</ul>
		<h2 style="font-size: 20px;margin:50px 0; font-weight: bold">Head of the Department of Computer Science</h2>
		<p>
			A.D.MustafaMahmoudSamiProfessor, Departmentof Computer Scienceandthe supervisor of thedepartment
		</p>
		<h2 style="font-size: 20px;margin:50px 0; font-weight: bold">Reseach Group</h2>
		<p>
		...
		<h2 style="font-size: 20px;margin:50px 0; font-weight: bold">Objectives</h2>
		<p>
			Emanate goals section of the objectives of the College as follows
		</p>
		<ol>
